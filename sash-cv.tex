	...
	\resumeSubheading
		...
		\resumeItemListStart
			\resumeItem
					...
					{\linebreak - Developed and maintained SLES and RHEL OS for LinuxONE Baremetal on VPC (Virtual Private Cloud) for IBM Cloud. \linebreak - Developed and automated the building of OS images that supported zVSI (KVM on Z) and LPAR on IBM Cloud VPC. \linebreak - Developed automation scripts for maintaining LinuxONE Baremetal. \linebreak - Contributed to the implementation of SSC (Secure Service Container) on LinuxONE Baremetal on VPC.}
			\resumeItem
					{HPVS (Hyper Protect Virtual Server) On-Prem and IBM Cloud Confidential Computing Project}
                    {\linebreak - Developed and maintained a Terraform provider for HPVS, supporting the latest releases for both on-prem and IBM Cloud. \linebreak - Developed new systemd services and updated bootloader to add features such as static IP, contract expiration, and custom tag support in logs. \linebreak - Developed scripts to automate manual release tasks to reduce manual effort for DevOps team. \linebreak - Addressed customer issues related to the HPVS Terraform provider.}
		\resumeItemListEnd
