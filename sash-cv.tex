...
\section{Experience}
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			\resumeItemListStart
				\resumeItem
					{As a part of LPARaaS Team}
					{\linebreak Developed and maintained SLES and RHEL OS for LinuxONE Baremetal on VPC (Virtual Private Cloud) for IBM Cloud. \linebreak Developed and automated building of OS images that supported zVSI (KVM on Z) and LPAR on IBM Cloud VPC. \linebreak Developed automation scripts for maintaining LinuxONE Baremetal. \linebreak Contributed in bringing SSC (Secure Service Container) on LinuxONE Baremetal on VPC.}
				\resumeItem
					{As a part of HPVS (Hyper Protect Virtual Server) Team}
					{Maintain bootloader for HPVS on IBM Cloud.}
			\resumeItemListEnd
...
\section{Skills Summary}
	\resumeSubHeadingListStart
		\resumeSubItem{Languages}{~~~~~~Python, Go, Bash, Embedded C++}
		\resumeSubItem{Tools}{~~~~~~~~~~~~~~GIT, Docker, Kubernetes, Postman}
		\resumeSubItem{Platforms}{~~~~~~~Linux Kernal, Arduino, Raspberry Pi, Autodesk Eagle, Fusion 360}
	\resumeSubHeadingListEnd
