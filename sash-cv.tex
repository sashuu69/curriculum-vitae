...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
	...
	\href{https://sashwat.in}{Portfolio: sashwat.in}\\
	 \href{https://github.com/sashuu69}{Github: ~~github.com/sashuu69} \\
\end{tabular*}
		...
		\resumeSubheading
			...
			\resumeItemListStart
				...
				\resumeItem
					...
					{Developed and maintained a Terraform provider for HPVS, supporting the latest releases for both on-prem and IBM Cloud. \linebreak Developed features like custom tags for HPVS logs to LogDNA for easier filtering and contract expiry settings for instances. \linebreak Developed scripts to automate manual release tasks, reducing manual effort. \linebreak Addressed customer issues related to the HPVS Terraform provider.}
			\resumeItemListEnd
...
\section{Skills Summary}
	\resumeSubHeadingListStart
		\resumeSubItem{Languages}{~~~~~~Go, Python, Bash}
		\resumeSubItem{Tools}{~~~~~~~~~~~~~~Git, Docker, Terraform, Ansible}
		\resumeSubItem{Platforms}{~~~~~~~Linux}
	\resumeSubHeadingListEnd
