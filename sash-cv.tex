...
\section{Education}
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			{Post Graduation - Bachelor in Computer Applications;  GPA: 7.0}{August. 2017 - April. 2020}
		\resumeSubheading
			{Christ Nagar College}{Thiruvananthapuram, India}
			{Graduation - Masters in Computer Applications;  GPA: 7.2}{June. 2014 - May. 2017}
		\resumeSubheading
...
\section{Skills Summary}
	\resumeSubHeadingListStart
		\resumeSubItem{Languages}{~~~~~~Python, C-Shell, Embedded C++}
		\resumeSubItem{Tools}{~~~~~~~~~~~~~~GIT, Docker, Docker-Compose, Postman, ICManage, Perforce Helix Core, LSF License Scheduler}
...
\begin{comment}
\vspace{-5pt}
\section{Workshops Hosted}
	\begin{description}[font=$\bullet$]
		\item {Git Workshop - College of Engineering Trivandrum}
		\vspace{-5pt}
		\item {Git Workshop - Muthoot Institute of Technology and Science, Kochi}
		\vspace{-5pt}
		\item {Raspberry Pi Workshop - IOT Lab, College of Engineering Trivandrum}
		\vspace{-5pt}
		\item {Arduino Workshop - IOT Lab, College of Engineering Trivandrum}
		\vspace{-5pt}
		\item {Beaglebone Workshop - IOT Lab, College of Engineering Trivandrum}
		\vspace{-5pt}
		\item {Raspberry Pi Workshop - Drishti Fest, College of Engineering Trivandrum}
	\end{description}
\end{comment}
