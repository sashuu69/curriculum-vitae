	...
	\resumeSubheading
		...
		\resumeItemListStart
			\resumeItem
					...
					{\linebreak - Developed and maintained \textbf{SLES} and \textbf{RHEL} OS for \textbf{LinuxONE Baremetal on VPC (Virtual Private Cloud) for IBM Cloud}. \linebreak - Implemented \textbf{IBM Cloud zVSI (KVM on Z)} and LPAR supported images with automation to reduce building time by \textbf{80\%}. \linebreak - Developed \textbf{automation scripts} using \textbf{Python} for maintaining LinuxONE Baremetal. \linebreak - Enabled \textbf{SSC (Secure Service Container)} functionality for enhanced confidentiality in BareMetal infrastructure using \textbf{GoLang}. \linebreak - Mentored interns during project onboarding, helping them understand the architecture, development practices, and internal tools to enable effective contributions early in their tenure.}
			\resumeItem
					{Hyper Protect Virtual Server (HPVS), Hyper Protect Container Runtime for RedHat Virtualization Solutions (HPCR RHVS) | Confidential Computing}
                    {\linebreak - Added features such as static IP assignment, contract expiration enforcement, structured log tagging through \textbf{SystemD} services, and \textbf{Bootloader} enhancements and a few more for enhancing customer experience. \linebreak - Designed and maintained open source \href{https://github.com/ibm-hyper-protect/terraform-provider-hpcr}{\textbf{Terraform provider for HPVS}}, reducing manual deployment overhead for customers. \linebreak - Added HPCR-RHVS support to IBM Cloud Infrastructure Center (ICIC) (OpenStack) \linebreak - Automated release operations, reducing DevOps overhead by \textbf{70\%}. \linebreak - Developed open-source \href{https://github.com/ibm-hyper-protect/contract-go}{\textbf{Go library}} and \href{https://github.com/ibm-hyper-protect/contract-cli}{\textbf{CLI tool}} developed to automate contract generation for customers. \linebreak - Proactively resolved customer complaints, improving satisfaction and adoption. \linebreak - Mentored new joiners in HPVS architecture and Terraform provider development, enabling them to contribute to feature implementation, debugging, and release workflows.}
        \resumeItemListEnd
